...
int64_t skinny_gemm_tb(torch::Tensor& A, torch::Tensor& B, torch::Tensor& D, torch::Tensor& scale_tensor,
                       int64_t split_k, int64_t A_producers, int64_t B_producers, int64_t consumers, int64_t a_lanes,
                       int64_t b_lanes, int64_t qsize, int64_t op_m, int64_t ops);
