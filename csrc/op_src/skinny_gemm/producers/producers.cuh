...
void __device__ produce_A_tiles(const fp8* __restrict__ A, fp8* A_buffer, const int A_producers, int* A_queue,
                                int& index, int& p_state, int& role_id, int k, const int k_blocks,
...
void __device__ produce_B_tiles(const fp8* __restrict__ B, fp8* B_buffer, const int B_producers, int* B_queue,
                                int& index, int& p_state, int& role_id, int b_stride, const int k_blocks) {
